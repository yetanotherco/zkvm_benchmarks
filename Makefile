...
rsp_risc0:
	RUST_LOG=info RISC0_INFO=1 ./rsp/risc0/target/release/host block_data/$(BLOCK_MEGAGAS)M.bin

rsp_risc0_cuda:
	RUSTFLAGS="-C target-cpu=native" RUST_LOG=info RISC0_INFO=1 ./rsp/risc0/target/release/host block_data/$(BLOCK_MEGAGAS)M.bin
